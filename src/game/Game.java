...
/**
 * A generic multi-player game, which may be sub-classed to implement a
...
public abstract class Game{
     ...
     * is started.  Subclasses should put such initialization behavior here.
     *
     */
 ...
 who wants to request an action on its behalf.
     *
     * @param action player requesting the action
     */
