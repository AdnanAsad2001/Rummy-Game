...
public final class RummyState extends GameState {
     ...
     */
    public RummyState(Stack<Card> stock, Stack<Card> discard, 
            Vector<Vector<Card> > hands, Vector<Vector<Card> > melds, 
            Vector<String> newChatHistory, int currentPlayer, 
            Vector<Move> moves, int[] score) {
    ...
    /**
     * Gets the stuff for the move log.
     * @return 
     */
