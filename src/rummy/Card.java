...
public class Card implements Comparator<Card> {
    ...
    public Card(int id) {
        ...
        if(id < 10){ 
            this.IMAGE = "images//default//0" + id + ".gif";
        }
        else {
            this.IMAGE = "images//default//" + id + ".gif";
        }
    }
    ...
    public Card(Suit suit, Rank rank){
        ...
        if(this.ID < 10) {
            this.IMAGE = "images//default//0" + this.ID + ".gif";
        }
        else {
            this.IMAGE = "images//default//" + this.ID + ".gif";
        }
    }
    ...
    /**
     * Implements Compare's comparison operator for Card class.This
